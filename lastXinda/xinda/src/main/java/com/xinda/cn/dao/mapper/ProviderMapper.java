...
//服务商  找回密码
	int findPasswordByCellphone(@Param("record") Provider record, @Param("example") ProviderExample example,  @Param("cellphone")String cellphone);
	  //运营商    查找服务商返回记录数
	long searchServiceNameCount(String serviceName);
}