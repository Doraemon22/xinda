$(".search-btn").on("click", function(){
    ...
    location.href="/findByRecommendname?name="+name;
})
$(function(){
	...
	if(cpage<=10){
		for(var i=1;i<=cpage;i++){
			if(i==nowpage){
				strhtml+='<a href=/findByRecommendname?pageStart='+psize*(i-1)+'&name='+name+' style="background-color:#aaaaaa">'+i+'</a>';
			}else{
				strhtml+='<span> <a href=/findByRecommendname?pageStart='+psize*(i-1)+'&name='+name+'>'+i+'</a></span>';
			}
		}
		...
		for(var i=1;i<=10;i++){
			if(i==nowpage){
				strhtml+='<a href=/findByRecommendname?pageStart='+psize*(i-1)+'&name='+name+' style="background-color:#aaaaaa;font-weight:700">'+i+'</a>';
